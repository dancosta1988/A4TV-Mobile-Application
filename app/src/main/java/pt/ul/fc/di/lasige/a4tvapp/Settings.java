...
public class Settings extends AppCompatPreferenceActivity {
    ...
    public void deleteStorage(){
        System.err.println( "Deletingggggg");
    }
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                || UserProfilePreferenceFragment.class.getName().equals(fragmentName)
                || DataSyncPreferenceFragment.class.getName().equals(fragmentName)
                || TTSPreferenceFragment.class.getName().equals(fragmentName)
                || DataStoragePreferenceFragment.class.getName().equals(fragmentName)
    ...
    public static class DataSyncPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("Set-Top Box IP address"));
        }
    ...
    public static class TTSPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.tts_pref_source);
            setHasOptionsMenu(true);
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            bindPreferenceSummaryToValueBoolean(findPreference("TTS Preference Source"));
        }
    ...
    public static class DataStoragePreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            bindPreferenceSummaryToValueBoolean(findPreference("delete_storage"));
        }
    ...
    public static class GesturePreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("gesture_preference"));
        }
